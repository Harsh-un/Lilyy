...
buttons = [
    [
        ...
        InlineKeyboardButton(text="ɪɴғᴏ", callback_data="mukesh_"),
...
ʏᴏᴜ ᴄᴀɴ ᴅɪʀᴇᴄᴛʟʏ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴘᴇʀ @harsh\_un ғᴏʀ ᴅᴏɴᴀᴛɪɴɢ ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴠɪsɪᴛ ᴍʏ sᴜᴩᴩᴏʀᴛ ᴄʜᴀᴛ @kira\_suport ᴀɴᴅ ᴀsᴋ ᴛʜᴇʀᴇ ᴀʙᴏᴜᴛ ᴅᴏɴᴀᴛɪᴏɴ."""
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            x=update.effective_message.reply_sticker(
                "CAACAgUAAx0CeaYnAAMtzWYxC2sgB26s1pbXL64h-3VrL0k9AAJTDwACdAZBV6Tqu2VlEFPFHgQ")
            x.delete()
...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        InlineKeyboardButton(text="ʜᴇʟᴘ", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(
                            text="🚩sᴜᴩᴩᴏʀᴛ", callback_data="KIRA_suport"
                        ),
                        InlineKeyboardButton(
...
Yᴏᴜ ᴄᴀɴ ʜᴇʟᴘ ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴡɪᴛʜ ᴅᴏɴᴀᴛɪᴏɴs""",parse_mode=ParseMode.MARKDOWN,
        ...
        InlineKeyboardButton(text="ʜᴇʟᴘ", callback_data="Main_help"),
                    ...
                    [
                        InlineKeyboardButton(text="• Dᴏɴᴀᴛᴇ •", url="https://t.me/kira_suport"),InlineKeyboardButton(text="• sᴜᴘᴘᴏʀᴛ •", callback_data="mukesh_support")
                    ]
                ]
            ),
            )  
...
*ʜᴇʏ,
 ᴛʜɪs ɪs {BOT_NAME},
ᴀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ.*
...
""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
        InlineKeyboardButton(text="ɴᴇᴛᴡᴏʀᴋ", url="https://t.me/bankai_network")
                ],
                 [
        InlineKeyboardButton(text="ʜᴏᴍᴇ", callback_data="mukesh_back"),
        InlineKeyboardButton(text="ɪɴғᴏ", callback_data="mukesh_"),
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/Dazaii_pirobot?startgroup=true"
                            )
                       ]
                ]
                     )
